...
Possible Avenues for Vehicle/User Data​

Vehicle/user data can possibly offer value through direct monetization, cost optimization or improving customer experience. While the type of data for each avenue varies along with the privacy sensitivity, this will be a key input for data monetization strategy
